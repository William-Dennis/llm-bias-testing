...
Five comparison plots across all evaluated models, generated by `visualisations.py`:

### Cross-Model Heatmap

<img src="figs/cross_model_heatmap.png" width="700" alt="Cross-model benchmark heatmap">

Heatmap of every model × benchmark combination. Rows sorted by mean bias (lower = greener).

### StereoSet Category Breakdown

<img src="figs/stereoset_categories.png" width="700" alt="StereoSet category breakdown">

StereoSet stereotype scores broken down by category (gender, race, religion, profession) per model.

### WinoBias Pronoun Accuracy

<img src="figs/winobias_pronouns.png" width="700" alt="WinoBias pronoun accuracy">

WinoBias accuracy per pronoun (he/she/they) across models. Large gaps indicate gendered prediction bias.
...
Scatter plot of parameter count vs bias score per benchmark, with trend lines. Explores the relationship between model scale and bias.
